...
export default function AdminDashboard() {
  ...
  // Redirect to login if adminEmail not found in localStorage
  useEffect(() => {
  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-card">
        ...
        {/* Section Title */}
        <p className="section-title">Admin Controls</p>

        {/* Buttons */}
        <div className="button-group">
          <button
            className="dashboard-button"
            onClick={() => handleClick("Adddepthead")}
          >
            Add Department Head
          ...
          <button
            className="dashboard-button"
            onClick={() => handleClick("viewdepthead")}
          >
